...
(function () {
  ...
  // 2026-07-16：電腦有兩個 IP——Wi-Fi 192.168.68.91、乙太網路
  // 192.168.1.101。實測使用者手機連得到乙太網路那個（router 有
  // bridge），用 192.168.1.101。原本寫的 192.168.68.90 是錯的。
  var LOCAL_DEV_IP = "192.168.1.101";
