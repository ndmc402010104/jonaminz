...
(function () {
  ...
  var ROOT_TOKENS = [
    ...
    { type: "color", name: "--color-bg", label: "Background（淺色）" },
    { type: "color", name: "--color-bg-dark", label: "Background（深色）" },
    { type: "color", name: "--color-text", label: "Text（淺底）" },
    { type: "color", name: "--color-text-dark", label: "Text（深底）" },
