...
(function () {
  ...
  var ROOT_TOKENS = [
    ...
    { type: "color", name: "--color-bg-jonathan", label: "Background（Jonathan）" },
    { type: "color", name: "--color-surface-jonathan", label: "Surface（Jonathan）" },
    { type: "color", name: "--color-surface-jonathan-elevated", label: "Surface Elevated（Jonathan）" },
    { type: "color", name: "--color-text-jonathan", label: "Text（Jonathan）" },
    { type: "color", name: "--color-jonathan-accent", label: "Accent（Jonathan）" },
    { type: "color", name: "--color-jonathan-accent-2", label: "Accent 2（Jonathan）" },
