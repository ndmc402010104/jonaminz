...
(function () {
  ...
  function mountChatLauncher() {
    try {
      ...
      style.textContent =
        // 2026-07-15：跟 assets/js/chat-launcher.js 同一個修法——
        // border-radius:50% 會讓 <iframe> 自己也裁成正圓，跟 clip-path
        // 的 union 形狀交集之後，角標/小綠點的補償小圓就白做了，拿掉
        // border-radius，形狀完全交給 clip-path（見那邊完整說明）。
